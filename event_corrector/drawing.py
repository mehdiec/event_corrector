...
class CellClassificationWidget(QWidget):
    def __init__(self, viewer: napari.Viewer):
        ...
        image_data = skimage.io.imread("/home/polina/Downloads/cells3d.tif")[
            :, 1
        ]  # Use just one channel of the sample 3D image
        self.viewer.add_image(image_data, name="raw_image")

        self.labels_layer = self.viewer.add_labels(
            np.zeros_like(image_data), name="labels"
        )
...
cell_widget = CellClassificationWidget(viewer)
